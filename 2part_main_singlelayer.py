...
def main():
    ...
    for step in range(100):
        ...
        # 每隔5步可视化
        if step % 5 == 0:
            Analysis.plot_cell_vertices(vm, save_path=f"/home/kaiyi/RD_VM/RD_VM_cuboid/2vm_rd_singlelayer/vertices_{step:04d}.pdf")
            Analysis.plot_concentration(simulator.rd.concentration[0, :], save_path=f"/home/kaiyi/RD_VM/RD_VM_cuboid/2vm_rd_singlelayer/conc_{step:04d}.pdf")
            
            #stability = simulator.analyze_stability(window_size=5)
            #Analysis.plot_potential(stability, save_path=f"/home/kaiyi/RD_VM/2vm_rd_singlelayer/potential_{step:04d}.pdf")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("/home/kaiyi/RD_VM/RD_VM_cuboid/2vm_rd_singlelayer/potential_evolution.pdf")
    plt.close()
