...
def main(x_min=None, x_max=None, y_min=None, y_max=None, threshold=13):
    ...
    for step in range(50):
        ...
        if step % 5 == 0:
            Analysis.plot_hex_prisms(vm, 
                save_path=f"/home/kaiyi/RD_VM/RD_VM_hexagon/3vm_rd_singlelayer/vertices_{step:04d}.pdf")
            Analysis.plot_concentration(simulator.rd.concentration[0], 
                save_path=f"/home/kaiyi/RD_VM/RD_VM_hexagon/3vm_rd_singlelayer/conc_{step:04d}.pdf")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("/home/kaiyi/RD_VM/RD_VM_hexagon/3vm_rd_singlelayer/potential_evolution.pdf")
    plt.close()
