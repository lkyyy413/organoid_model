...
import numpy as np
import math
from rd_reaction_singlelayer import RDReaction
...
class CoupledSimulator:
    def __init__(self, vertex_model, rd_model=None, dt=0.01, coupling_strength=0.1):
        ...
        # 验证细胞数与浓度网格匹配
        #print(len(vertex_model.cube_vertex_indices))
        ...
        if rd_model is None:
            ...
            initial_concentration = self.init_concentration(grid_shape=(1, 2, grid_size, grid_size), low=10, high=11)[0]
    ...
    def init_concentration(self, grid_shape=(100, 100), low=10, high=11):
        """初始化浓度场（自定义范围）"""
